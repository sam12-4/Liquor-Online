...
import { userLogin, isUserLoggedIn, requestUserPasswordReset } from '../utils/auth';
...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (forgotPassword) {
        const result = await requestUserPasswordReset(formData.email);
      ...
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-lg shadow-md">
        ...
        <div className="text-center mt-4">
          <p className="text-sm text-gray-600">
            For testing, use: <span className="font-medium">user@example.com / user123</span>
          </p>
        </div>
      </div>
    </div>
