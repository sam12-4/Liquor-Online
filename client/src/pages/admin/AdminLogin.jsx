      ...
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-lg shadow-md">
        <div>
          <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">
            {forgotPassword ? 'Admin Password Reset' : 'Admin Sign In'}
          </h2>
          <p className="mt-2 text-center text-sm text-gray-600">
            {forgotPassword 
              ? 'Enter your email to receive a reset link on your designated contact methods' 
              : 'Secure access for administrative functions'}
          </p>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          {forgotPassword && (
            <div className="text-center text-sm text-gray-500 mt-2">
              <p>For security, reset instructions will be sent to your designated recovery contact methods.</p>
            </div>
          )}
          ...
          <div>
            ...
            >
              ...
              ) : (forgotPassword ? 'Send Reset Link' : 'Sign in to Admin')}
            </button>
          </div>
        ...
        <div className="text-center mt-4">
          ...
          {forgotPassword && (
            <p className="text-xs text-gray-500 mt-2">
              Reset instructions will be sent to sameerh64h@gmail.com and +923278443240
            </p>
          )}
        </div>
      </div>
